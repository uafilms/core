      ...
      {activeTab === 'docs' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <article className="surface-container round no-margin" style={{ padding: '20px' }}>
            ...
            <p className="small-text surface-variant-text" style={{ margin: '0 0 16px 0' }}>
              Ви можете передавати ваш API-ключ у заголовку <code>x-api-key</code>, у заголовку <code>Authorization: Bearer uaf_live_...</code> або в query-параметрі <code>?api_key=...</code>.
            </p>
